...
namespace Item
{
    ...
    void ITextEdition::saveTextEdition( Data::DataManager & settings, const QString & group, const QString & subGroup )
    {
    ...
    void ITextEdition::loadTextEdition( Data::DataManager & settings, const QString & group, const QString & subGroup )
    {
